...
public class ByRegex {
    ...
    private void putFieldByUrl(){
        page.putField(name,page.getUrl().regex(ruleDetails).toString());
    }
    /**
     * Html
     */
    private void putFieldByHtml(){
        page.putField(name,page.getHtml().regex(ruleDetails).toString());
    }
    ...
    private void putFieldByJson(){
        page.putField(name,page.getJson().regex(ruleDetails).toString());
    }
}
